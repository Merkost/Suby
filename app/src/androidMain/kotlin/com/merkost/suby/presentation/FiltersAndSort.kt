...
import suby.app.generated.resources.filter_by
import suby.app.generated.resources.sort_by
...
fun SortFilterBottomSheet(
    ...
    ModalBottomSheet(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Text(
                text = org.jetbrains.compose.resources.stringResource(Res.string.filter_by),
            ...
            Text(
                text = org.jetbrains.compose.resources.stringResource(Res.string.sort_by),
                style = MaterialTheme.typography.titleLarge,
                modifier = Modifier.padding(bottom = 8.dp)
            )
